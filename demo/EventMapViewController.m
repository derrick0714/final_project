...
- (void)viewDidLoad
{
    ...
    pinCoordinate.latitude = self.latitude; //should be data from server / double float type
    pinCoordinate.longitude = self.longitude; //should be data from server / double float type
